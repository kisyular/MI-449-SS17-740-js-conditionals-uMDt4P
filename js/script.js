...
var paraH = 'You finished chopping your left-hand off. A strong wave of unbearable pain hits you and autonomous reflex causes you to throw the saw away. In the room, there are two keys. One is blue and the other is green. CONTINUE?'
...
var paraHR = 'You pick up the Green key and you start walking through the tiny corridor. You picked the wrong key. You cannot return for the blue one. You have been given another chance, but this time you have to open the door with PIN. Guess the PIN Correctly. CONTINUE?'
